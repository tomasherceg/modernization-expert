    ...
    public static class DatabaseHelper
    {
        ...
        public static void CreateAndSeedDatabase()
        {
            ...
            using (var context = new DotNetCollegeContext())
            {
                ...
                suppliers.ForEach(context.Suppliers.AddObject);
                ...
                locations.ForEach(context.Locations.AddObject);
                ...
                mainCategories.ForEach(context.MainCategories.AddObject);
                ...
                courseTemplates.ForEach(context.CourseTemplates.AddObject);
