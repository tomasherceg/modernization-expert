...
namespace ModernizationDemo.EfCoreTests
{
    [TestClass]
    public class DatabaseTests
    {
        private const string connectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=EFTestsNew;Integrated Security=True;TrustServerCertificate=True";
