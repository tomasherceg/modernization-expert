...
namespace ModernizationDemo.MembershipCoreIdentityTests
{
    ...
    public class LoginTests
    {
        ...
        public async Task Init()
        {
            ...
            var oldConnectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=MembershipTests;Integrated Security=True;Trust Server Certificate=true";
            ...
            var newConnectionString = "Data Source=.\\SQLEXPRESS;Initial Catalog=MembershipMigratedTests;Integrated Security=True;Trust Server Certificate=true";
            ...
            services.Replace(ServiceDescriptor.Scoped<IPasswordHasher<AppUser>, MembershipAwarePasswordHasher>());
            provider = services.BuildServiceProvider();

            // migrate the database
            var migrator = ActivatorUtilities.CreateInstance<MembershipMigrator>(provider);
